...
include_router_safe(app, "backend.routers.tracking_collector")
...
include_router_safe(app, "backend.routers.gd_sales")
include_router_safe(app, "backend.routers.gd_intelligence")
include_router_safe(app, "backend.routers.paid_media")
include_router_safe(app, "backend.routers.intelligence_platform")
include_router_safe(app, "backend.routers.omnichannel")
