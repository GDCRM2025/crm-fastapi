...
from .exceptions import ReceiverRUTMismatch, SIIError
...
class SIIReceivedDocumentsService:
    ...
    def import_rcv_csv(self, legal_entity_id: int, csv_bytes: bytes, *, actor: dict[str, Any]) -> dict[str, Any]:
        ...
        return self.import_documents(legal_entity_id, parse_rcv_csv(csv_bytes, receiver_rut=receiver_rut), actor=actor, source="SII_RCV_CSV")
