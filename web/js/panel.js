  ...
  },
  {
    ...
    items: [
  ...
  },
	  {
	    ...
	    title: "Tools",
	    items: [
	      { id: "tool_gmail", label: "Correo", url: "/web/views/tools.html?v=20260806-video-ready-v3#correo" },
	      { id: "tool_ig", label: "Instagram", url: "/web/views/tools.html?v=20260806-video-ready-v3#instagram" },
	      { id: "tool_wapp", label: "WhatsApp", url: "/web/views/tools.html?v=20260806-video-ready-v3#whatsapp" },
	      { id: "tool_calc", label: "Calculadora", url: "/web/views/tools.html?v=20260806-video-ready-v3#calc" },
    ...
    try {
      ...
      if (grew || grewOpen) {
        toast(`Correo: ${openTotal} pendiente(s)`, {
          kind: "ok",
          ms: 8e3,
	          onClick: () => openItem({ id: "tool_gmail", url: "/web/views/tools.html?v=20260806-video-ready-v3#correo" })
	        });
	      }
