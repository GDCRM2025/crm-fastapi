...
const MENU = [
  {
    ...
    items: [
      ...
      { id: "leads_fil", label: "Filtrar Leads", url: "/web/views/filtro_leads.html?v=20260810-filtros2" },
  ...
  },
  {
    ...
    title: "Cotizador",
    items: [
      { id: "historial", label: "Historial", url: "/web/views/historial_cotizaciones.html?v=20260810-filtros2" }
    ]
  },
  {
    id: "reportes",
