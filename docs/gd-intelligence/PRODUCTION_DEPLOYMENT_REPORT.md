...
| SHA candidato funcional validado | `b315574` |
| Alcance candidato | GD Intelligence core, RBAC, Sites, CredentialVault, Integration Center, UTM, Site Health, tracking, atribución, Paid Media read-only y Help Engine |
